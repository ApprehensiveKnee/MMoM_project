...
This repository contains the code and data for the project of the "Molecular Modeling of Materials" (MMoM) course at Politecnico di Milano. The <b>chosen topic</b> is the study of absorption of hydrogen molecules in gas phase by graphene nanofibers (GNFs). Both DFT and MD analyses are performed to investigate the phenomenon.
...
- `visual.ipynb`: the notebook where hosting the general idea and logic thread followed in the making of this project. HAVE A LOOK HERE FOR IN-DEPTH ANALYSIS OF THE PROBLEM.
